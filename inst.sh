...
[[ "$tmpTARGETMODE" == '5' ]] && {
  printf "\n ✔ %-30s" "Copying vmlinuz ......" && { [[ -d $instto ]] && cat $topdir/_build/debianbase/$([ "$tmpHOSTARCH" == '1' -a "$tmpHOSTARCH" != '' ]  && echo -n binary-arm64 || echo -n binary-amd64)/tarball/vmlinuz$([ "$tmpHOSTARCH" == '1' -a "$tmpHOSTARCH" != '' ]  && echo -n _arm64)_* > $instto/vmlinuz_1kddinst && echo -en "[ \033[32m done. \033[0m ]"; }
  sleep 2 && printf "\n ✔ %-30s" "Copying initrfs ......" && { [[ -d $instto ]] && cat $topdir/_build/debianbase/$([ "$tmpHOSTARCH" == '1' -a "$tmpHOSTARCH" != '' ]  && echo -n binary-arm64 || echo -n binary-amd64)/tarball/initrfs$([ "$tmpHOSTARCH" == '1' -a "$tmpHOSTARCH" != '' ]  && echo -n _arm64).img_* > $instto/initrfs_1kddinst.img && echo -en "[ \033[32m done. \033[0m ]"; }
}
